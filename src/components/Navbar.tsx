...
const Navbar = async () => {
    ...
    return (
        <nav className="sticky z-[100] h-14 inset-x-0 top-0 w-full boder-b border-gray-200 bg-white/75 backdrop-blur-lg transition-all">
            <MaxWidthWrapper>
                <div className="flex h-14 items-center justify-between border-b border-zing-200">
